...
public class PSA {
  ...
  public static Map<String, String> birthCertificate = new HashMap<>();
  ...
  public static void As(){
   BirthCertificate birthCertificate = new BirthCertificate();
    ...
    public static void adminFunctionalities(Scanner scanner) {
        int adminChoice;
        do {
                     System.out.println("  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
    ...
    public static void editUser() {
      ...
      Marriage A = new Marriage();
 System.out.println("Choose an option:");
            System.out.println("1. Birth Certificate");
        System.out.println("2. Marriage Certificate");
       ...
       if(Choice == 2){
        ...
        switch (choice) {
            ...
            default:
             ...
             System.out.println("User: admin Password: adminpassword!");
 PSA.add();
      } 
       }while(Choice !=0);
